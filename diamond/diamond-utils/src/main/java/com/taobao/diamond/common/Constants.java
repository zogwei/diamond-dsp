...
public class Constants {
    ...
    public static final String DEFAULT_DOMAINNAME = "conflist.dsp.cn";

    public static final String DAILY_DOMAINNAME = "confinfo.dsp.cn";

    public static final int DEFAULT_PORT = 1888;
